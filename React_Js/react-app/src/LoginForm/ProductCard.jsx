          ...
          <Grid item xs={12} sm={6} md={4} padding={1} key={product.id}>
              <Card sx={{ width: 400, height: 500 }}>
                ...
                <CardContent>
                  ...
                  <Chip label={`${product.discountPercentage}% off`} color="primary" sx={{marginTop:1}}/>
                  ...
                  <Button component={Link} to={`/products/${product.id}`}  rel="noreferrer" sx={{ marginTop: 1, "&:hover": { textDecoration: "underline", color: "#1769aa" }}}>
                    More details
                  </Button>
                </CardContent>
              </Card>
