...
let trainees = [
  ...
  // let slicedTraineeString = traineeString.slice(10, 18); // Slice a part of the string
  // console.log("\n Apply slice");
  // console.log(slicedTraineeString);

  let slicedTraineeString = traineeString.slice(-10, 18); // Slice a part of the string not work
  console.log("\n Apply slice");
  console.log(slicedTraineeString);
  ...
  let substringTraineeString = traineeString.substring(-10, 15); // Get a substring of the string its working
  console.log("\n Apply substring");
  console.log(substringTraineeString);
...
// //   console.log(trimmedEndTraineeString);
  ...
  let charAtTraineeString = traineeString.charAt(56); // Get the character at a specific index of the string
  console.log("\n Apply CharAt ");
  console.log(charAtTraineeString);
  
  let charCodeAtTraineeString = traineeString.charCodeAt(23); // Get the ASCII value of the character at a specific index of the string
  console.log("\n Apply charCodeAt");
...
//   // Using Array methods
  ...
  traineesArray.push("Ali"); // Add an element to the end of the array
  console.log("\n Apply push ");
  console.log(traineesArray);
